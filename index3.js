...
depositForm.addEventListener("submit", function (event) {
  ...
  depositUserElement.__proto__ = Bank.prototype;
//   console.log(depositUserElement);
// let newObj = Object.create(Bank.prototype);
// newObj.name = depositUserElement.name;
// newObj.date = depositUserElement.date;
// newObj.accountNumber = depositUserElement.accountNumber;
// newObj.balance = depositUserElement.balance;
// console.log(newObj);
...
withdrawForm.addEventListener("submit", function (event) {
  ...
  let accountNumberWithdraw = document.getElementById(
  ...
  let withdrawUserElement = arr.find(function (ele) {
    ...
    withdrawUserElement.__proto__ = Bank.prototype;
